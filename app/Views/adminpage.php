...
<table>
    <tr>
        <th>Username</th><th>Role</th><th></th><th></th>
    </tr>
<?php
...
?>
    <tr>
        ...
        <td><a href="<?php echo site_url('delete/'.$user['ID'])?>">Delete</a></td>
        <td><a href="<?php echo site_url('makeadmin/'.$user['ID'])?>">Make admin</a></td>
    </tr>
    <?php
        }
    ?>
